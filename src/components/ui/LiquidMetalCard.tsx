...
export const LiquidMetalCard: React.FC<LiquidMetalCardProps> = ({ 
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-black/5 backdrop-blur-xl rounded-xl border border-red-accent/10 z-0 transition-colors duration-500 group-hover:bg-black/20" />

      {/* 2. DEFAULT STATIC BORDER */}
      <div className="absolute inset-0 rounded-xl box-border ring-1 ring-text-primary/20 z-10 transition-colors duration-500 group-hover:ring-transparent pointer-events-none" />
      ...
      <div className="absolute inset-0 shadow-[inset_0_1px_1px_rgba(248,247,244,0.15)] rounded-xl z-30 pointer-events-none opacity-40 group-hover:opacity-100 transition-opacity duration-500" />
